...
---- Total Count and Percentage of Each Gender Type
...
---- Total Count and Percentage of Each Contract Type
...
---- Total Count and Percentage of Each StateType
...
-- Total Count and Percentage of Each Customer_Status

Select Customer_Status, count (Customer_Status) As TotalCount, Sum (total_revenue) as TotalRev,
count (Total_Revenue) *1.0/ (select sum (Total_Revenue) from Customer_Data) As Percentage
From Customer_Data
Group by Customer_Status
order by Percentage desc

-- Number of item on internet tye column 
...
-- Replacing the Null Values into Prod. Churn
SELECT 
    Customer_ID,
    Gender,
    Age,
